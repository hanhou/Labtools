function ha = tight_subplot(Nh, Nw, gap, marg_h, marg_w, ratio_h, ratio_w)
...
%                   starting from upper left corner, going column-wise ( NOT as in
%                    subplot !!)
%
...
for ii = 1 : Nh*Nw
    ...
    py = marg_h(2) + gap(1) * (Nw - i) + sum(axh(i+1:end));
