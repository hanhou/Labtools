...
cullcol=0;		% column of foo file to use to select subset of trials
...
cullmax=0;		% maximum value to use in selecting subset of trials
			% based on values in <cullcol> column of foo file
			
algparams=cell(6,1);
algparams{1}=14;			% upper (initial) threshold velocity in deg/sec
algparams{2}=8;			% lower (second) threshold velocity in deg/sec
algparams{3}=16;		% minimum duration of microsaccade
