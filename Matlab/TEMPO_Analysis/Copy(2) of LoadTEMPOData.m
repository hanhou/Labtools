...
if isempty(temp2)    
    all_trials = 1:size(temp3,3);	%list of indices for all trials; CRF, 2/21/06 -- added IF statement because my discrim-only datasets have no spike DB (and thus temp2 cannot be used to index all_trials)
else
