...
%            file_num = file_num + 1;
            if (output == 1)
                FILEOUT = 'z:\dir_tuning_stats.txt';
                fileid = [FILEOUT];
                ...
                fprintf(fwriteid, ' %2d', SpikeChan);
                 fprintf(fwriteid, ' %5.1f', pref_dir);
                 fprintf(fwriteid, ' %6.4f', p_value);
                 fprintf(fwriteid, ' %6.4f', DirDI);
                 fprintf(fwriteid, ' %6.4f', DSI);
