...
fid = fopen(outfile, 'a');
if (printflag)
    fprintf(fid, 'FILE\t\t DDI-1\t surr-disp(1)\t DDI-2\t surr-disp(2)\t DDI-3\t surr-disp(3)\t PrDir\t PrSpd\t PrHDsp\t RFX\t RFY\t RFDiam\t');
    fprintf(fid, '\r\n');
    printflag = 0;
end
buff = sprintf('%s\t %6.2f\t %6.2f\t %6.2f\t %6.2f\t %6.2f\t %6.2f\t %6.1f\t %6.2f\t %6.3f\t %6.2f\t %6.2f\t %6.2f\t', ...
