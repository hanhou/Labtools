function EyeCalibration(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
LB=[-10.0; 0.01; -10.0];
UB=[10.0; 100.0; 10.0];
[L_horiz_pars, L_vert_pars] = EyeCalib_Fitter(lh, lv, fh, fv, LB, UB, LB, UB);
[calib_lh, calib_lv] = ComputeCalibratedEyePosn(lh, lv, L_horiz_pars, L_vert_pars);
plot(calib_lh, calib_lv, 'ro');

[R_horiz_pars, R_vert_pars] = EyeCalib_Fitter(rh, rv, fh, fv, LB, UB, LB, UB);
