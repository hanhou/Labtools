function [horiz_pars, vert_pars] = EyeCalib2_Fitter(horiz_raw, vert_raw, horiz_desired, vert_desired, H_lower_bounds, H_upper_bounds, V_lower_bounds, V_upper_bounds)
...
horiz_pars = fmincon('EyeCalib2_Func',a,A,B,Aeq,Beq,LB,UB, NONLCON, OPTIONS);
...
LB=V_lower_bounds;
UB=V_upper_bounds;
vert_pars = fmincon('EyeCalib2_Func',a,A,B,Aeq,Beq,LB,UB, NONLCON, OPTIONS);
