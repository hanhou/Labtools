...
%some temporary stuff for testing timing stuff
...
if (output == 1)
   ...
   %also write out data in form suitable for plotting tuning curve with Origin.
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\DirectionTuning\V3ADirectionTuningSummary.dat'];
    printflag = 0;
...
if output2
    outfile = [BASE_PATH 'ProtocolSpecific\DirectionTuning\DirParamsSU_vs_LFP.mat'];
