...
function [modelFitRespon_VO, modelFit_VO,modelFitPara_VO, BIC_VO, RSquared_VO, rss_VO, time] = fitVO(spon,PSTH_data,spatial_data, nBins,reps,stimOnBin,stimOffBin,aMax,aMin)
...
% time parameters
time = (1: (stimOffBin - stimOnBin +1))' /(stimOffBin - stimOnBin +1)*1500/1000; % unit in s
