% CHI2_TEST_MLM.M: Implements a chi-square goodness of fit test.  
...
function [chi2, chiP] = Chi2_Test_MLM(datax, datay, funcname, params, num_free_params)
...
%funccall = [funcname '(uniquex, params)'];
%fity = eval(funccall);
fity = funcname( uniquex, params );
