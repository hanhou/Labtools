...
%fitting_models = [@Curvefit_head_centered_7p_asp_ng @Curvefit_head_centered_ng];
%fitting_bounds = [@Curvefit_head_centered_bounds_7p_asp_ng @Curvefit_head_centered_bounds_ng];
%fitting_tuning_models = [@Curvefit_cos_tuning_7p_asp @Curvefit_cos_tuning_7p];
% fitting_models = [ @Curvefit_head_centered_7p_gauss2 ];
% fitting_bounds = [  @Curvefit_head_centered_bounds_gauss ];
% fitting_tuning_models = [  @Curvefit_cos_tuning_7p_gauss2 ] ;

%--------------------------------------------------------
%settings for Zack's optic flow fits
 fitting_models = [@Curvefit_head_centered_7p_asp_half_ng];
 fitting_bounds = [@Curvefit_head_centered_bounds_half_ng];
 fitting_tuning_models = [@Curvefit_cos_tuning_7p_halfrectmodel];
%--------------------------------------------------------


%--------------------------------------------------------
% settings 5 param fits to single heading tuning functions
% fitting_models = [@Curvefit_head_centered_5ng];
% fitting_bounds = [@Curvefit_head_centered_bounds_5ng];
...
%fitting_tuning_models = [@Curvefit_cos_tuning_7p_halfrectmodel] ;
% fitting_models = [@Curvefit_head_centered_ng @Curvefit_head_centered_7p_asp_half_ng];
% fitting_bounds = [@Curvefit_head_centered_bounds_ng @Curvefit_head_centered_bounds_7p_asp_ng];
% fitting_tuning_models = [@Curvefit_cos_tuning_7p @Curvefit_cos_tuning_7p_halfrectmodel];
% fitting_models = [@Curvefit_head_centered_ng @Curvefit_eye_centered_ng ...
%         @Curvefit_eye_centered_ng_varyfix];
% fitting_bounds = [@Curvefit_head_centered_bounds_ng @Curvefit_eye_centered_bounds_ng ...
%         @Curvefit_eye_centered_bounds_ng_varyfix];
% fitting_tuning_models = [@Curvefit_cos_tuning_7p @Curvefit_cos_tuning_7p ...
%         @Curvefit_cos_tuning_7p];
% fitting_models = [ @Curvefit_eye_centered_ng];
% fitting_bounds = [ @Curvefit_eye_centered_bounds_ng];
% fitting_tuning_models = [ @Curvefit_cos_tuning_7p];
% fitting_models = [@Curvefit_head_centered_ng @Curvefit_eye_centered_ng_varyfix];
% fitting_bounds = [@Curvefit_head_centered_bounds_ng @Curvefit_eye_centered_bounds_ng_varyfix];
% fitting_tuning_models = [@Curvefit_cos_tuning_7p @Curvefit_cos_tuning_7p];
% fitting_models = [ @Curvefit_eye_centered_ng_varyfix];
% fitting_bounds = [ @Curvefit_eye_centered_bounds_ng_varyfix];
% fitting_tuning_models = [ @Curvefit_cos_tuning_7p];
% fitting_models = [@Curvefit_head_centered_ng ];
% fitting_bounds = [@Curvefit_head_centered_bounds_ng ];
% fitting_tuning_models = [@Curvefit_cos_tuning_7p ];

minimization_iterations = 50;  % number of times to iterate a complete minimization for each model fit
...
printer_contour_figures = '-PHP LaserJet 4200dtnsl';
...
use_backdoor_load = 0;
use_backdoor_fit = 0;
build_backdoor_load = 1;
build_backdoor_fit = 1;
