...
%-----------------------------------------------------------------------------------------------------------------------
function F = Curvefit_cos_tuning_7p(xp,azimuth,elevation)
...
if nonlin ~= 0
    ...
    max_g = ( exp(nonlin*max_g) - 1 ) / nonlin;
end

% normalize so that the amplitude term still reflects the overall amplitude.
F = g / max_g;
