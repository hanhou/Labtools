...
terms = CURVEFIT_NUM_FIXED_PARAMETERS_EC + dyn_terms*num_gazes;
...
for j=1:num_gazes
    i = (j-1)*dyn_terms + CURVEFIT_NUM_FIXED_PARAMETERS_EC+1;
...
% the fixed parameters are azimuth and elevation rotation angles.
x0 = rand(1,CURVEFIT_NUM_FIXED_PARAMETERS_EC).*[2*pi pi] - [pi pi/2];
