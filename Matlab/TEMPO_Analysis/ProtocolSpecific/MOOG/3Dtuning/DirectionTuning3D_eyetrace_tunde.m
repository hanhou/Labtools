...
if strcmp(process_type, 'local_mat_files' ) == 1
    ...
    %%%%%%%%%%%%%%  clear   %%%%%%%%%%%%%%%%%%%%%%%%%
    if strcmp(process_type,'tempo_gui')
        %There is no need to clear variables as were only running this once
    elseif strcmp(process_type, 'local_mat_files')        
        % Clearing variable to allow for the next data file to be loaded and analyzed
