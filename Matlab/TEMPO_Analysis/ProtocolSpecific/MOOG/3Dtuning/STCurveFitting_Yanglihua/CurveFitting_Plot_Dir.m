function CurveFit=CuveFitting_Plot(FILE,Plane,Azi_3D,Ele_3D,Azi_temp,Ele_temp,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough)
...
for i=1:length(Azi_temp) 
    ...
    PSTH_tempPlane(i,:)=StepMatrix{1}(RowIndex,ColIndex,:);  
...
for i=1:size(spacetime_data_trial,1)
    ...
    spacetime_data_re(i,:)=tempdata*1000/Step;
...
%clear XAzi Ytime;[XAzi,Ytime] = meshgrid([0:45:360],[0:Step*0.001:max(t)]);
clear XAzi Ytime;[XAzi,Ytime] = meshgrid([-180:45:180],[0:Step*0.001:max(t)]);
figure(FigureIndex);axes('position',[0.05 0.77 0.17 0.15]);%subplot('position', [0.1 0.7 0.22 0.22]);
clear spacetime_dataplot;spacetime_dataplot=[spacetime_data(5:8,:); spacetime_data(1:5,:)];
contourf(XAzi,Ytime,spacetime_dataplot');% contourf(XAzi,Ytime,spacetime_data');
caxis([0 130]);colorbar;    
set(gca, 'xtick', [] );set(gca, 'XTickMode','manual'); 
set(gca, 'xtick',[-180:90:180]);set(gca, 'xticklabel','-180|-90|0|90|180');
...
clear spacefit_Velplot;spacefit_Velplot=[spacefit_Vel(5:8,:); spacefit_Vel(1:5,:)];
contourf(XAzi,Ytime,spacefit_Velplot',10);caxis([0 130]);
colorbar;    
set(gca, 'xtick', [] );set(gca, 'XTickMode','manual'); 
set(gca, 'xtick',[-180:90:180]);set(gca, 'xticklabel','-180|-90|0|90|180');
set(gca, 'ytick', [] ); set(gca, 'YTickMode','manual');
...
error_surf = spacetime_dataplot - spacefit_Velplot;
...
clear spacefit_VelAccplot;spacefit_VelAccplot=[spacefit_VelAcc(5:8,:); spacefit_VelAcc(1:5,:)];
contourf(XAzi,Ytime,spacefit_VelAccplot');caxis([0 130]);
colorbar;    
set(gca, 'xtick', [] );set(gca, 'XTickMode','manual'); 
set(gca, 'xtick',[-180:90:180]);set(gca, 'xticklabel','-180|-90|0|90|180');
% set(gca, 'xtick',[0:90:360]);set(gca, 'xticklabel','0|90|180|270|360');
...
error_surf = spacetime_dataplot - spacefit_VelAccplot;
err_VelAcc = cosnlin_err(vect_VelAcc);
figure(FigureIndex);axes('position',[0.26 0.31 0.17 0.15]);
contourf(XAzi,Ytime,error_surf'); caxis([0 130]);
colorbar;
set(gca, 'xtick', [] );set(gca, 'XTickMode','manual'); 
% set(gca, 'xtick',[0:90:360]);set(gca, 'xticklabel','0|90|180|270|360');
set(gca, 'xtick',[-180:90:180]);set(gca, 'xticklabel','-180|-90|0|90|180');
...
clear spacefit_VelAccPosplot;spacefit_VelAccPosplot=[spacefit_VelAccPos(5:8,:); spacefit_VelAccPos(1:5,:)];
contourf(XAzi,Ytime,spacefit_VelAccPosplot',10);caxis([0 130]);
colorbar;    
set(gca, 'xtick', [] );set(gca, 'XTickMode','manual'); 
% set(gca, 'xtick',[0:90:360]);set(gca, 'xticklabel','0|90|180|270|360');
set(gca, 'xtick',[-180:90:180]);set(gca, 'xticklabel','-180|-90|0|90|180');
...
error_surf = spacetime_dataplot - spacefit_VelAccPosplot;
...
%      end
    ...
    plot(x_time,model_Vel(i,:),'r','LineWidth',3); hold on;   
    plot(x_time,model_VelAcc(i,:), 'g', 'LineWidth', 3);hold on;
%     plot(x_time,model_VelAccPos(i,:),'c','LineWidth',3);hold on;
...
saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting1.png'],'png');
saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting1.fig'],'fig');
saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting1.emf'],'emf');
% close(FigureIndex);
