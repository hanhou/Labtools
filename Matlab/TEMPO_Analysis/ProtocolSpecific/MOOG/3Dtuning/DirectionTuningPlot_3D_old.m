...
% % %     for i=1:length(unique_azimuth)
% % %         for j=1:length(unique_elevation)
% % %             select_rep = logical( azimuth==unique_azimuth(i) & elevation==unique_elevation(j) & condition_num==unique_condition_num(k) );
% % %             select_repp = find( azimuth==unique_azimuth(i) & elevation==unique_elevation(j) & condition_num==unique_condition_num(k) );
% % %             if (sum(select_rep) > 0) 
% % %                 n=n+1;
% % %                for q=1:1:repetitions    
% % %                    resp_mat_anova{k}(q,n) = spike_rates(select_repp(q));                  
% % %                end
% % %            end
% % %        end
% % %    end
% % %    [p_anova(k), table, stats] = anova1(resp_mat_anova{k},[],'off');
% % % end
% % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % 
% % resp_mat_anova = [];
