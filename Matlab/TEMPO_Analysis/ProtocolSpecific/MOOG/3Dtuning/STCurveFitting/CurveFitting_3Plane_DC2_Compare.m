function CurveFitting_3Plane_DC2_Compare(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol, OutputPath)
...
% CurveFit_Hor=CurveFitting_Plot_Vel_NDC2(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
% CurveFit_Hor=CurveFitting_Plot_VelAcc_NDC2(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
CurveFit_Hor=CurveFitting_Plot_VelAccPos_NDC2(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);

%Save the figure 
FigureIndex=2;
if ~isempty(CurveFit_Hor)
    figure(FigureIndex); set(gcf, 'PaperOrientation', 'portrait');
    saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting_Hor_DC2.png'],'png');close(FigureIndex);
    %Save the Data
    SaveFileName=[OutputPath FILE(1:end-4) '_CurveFitHor_DC2'];
...
%CurveFit_Front=CurveFitting_Plot_Vel_NDC2(FILE,'Frontal Plane',Azi_3D,Ele_3D,Azi_Front,Ele_Front,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
%CurveFit_Front=CurveFitting_Plot_VelAcc_NDC2(FILE,'Frontal Plane',Azi_3D,Ele_3D,Azi_Front,Ele_Front,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
CurveFit_Front=CurveFitting_Plot_VelAccPos_NDC2(FILE,'Frontal Plane',Azi_3D,Ele_3D,Azi_Front,Ele_Front,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);

if ~isempty(CurveFit_Front)
    %Save the figure 
    figure(FigureIndex); set(gcf, 'PaperOrientation', 'portrait');
    saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting_Front_DC2.png'],'png');close(FigureIndex);
    %Save the Data
    SaveFileName=[OutputPath FILE(1:end-4) '_CurveFitFront_DC2'];
...
% CurveFit_Med=CurveFitting_Plot_Vel_NDC2(FILE,'Median Plane',Azi_3D,Ele_3D,Azi_Med,Ele_Med,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
% CurveFit_Med=CurveFitting_Plot_VelAcc_NDC2(FILE,'Median Plane',Azi_3D,Ele_3D,Azi_Med,Ele_Med,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
CurveFit_Med=CurveFitting_Plot_VelAccPos_NDC2(FILE,'Median Plane',Azi_3D,Ele_3D,Azi_Med,Ele_Med,Step,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);

if ~isempty(CurveFit_Med)
    %Save the figure 
    figure(FigureIndex); set(gcf, 'PaperOrientation', 'portrait');
    saveas(gcf,[OutputPath FILE(1:end-4) '_CurveFitting_Med_DC2.png'],'png');close(FigureIndex);
    %Save the Data
    SaveFileName=[OutputPath FILE(1:end-4) '_CurveFitMed_DC2'];
