function CurveFitting_3Plane_FEF(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol, OutputPath)
...
CurveFit_Hor=CurveFitting_Plot_FEF(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
%Save the figure 
FigureIndex=2;
...
CurveFit_Front=CurveFitting_Plot_FEF(FILE,'Frontal Plane',Azi_3D,Ele_3D,Azi_Front,Ele_Front,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
...
CurveFit_Med=CurveFitting_Plot_FEF(FILE,'Median Plane',Azi_3D,Ele_3D,Azi_Med,Ele_Med,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough);
