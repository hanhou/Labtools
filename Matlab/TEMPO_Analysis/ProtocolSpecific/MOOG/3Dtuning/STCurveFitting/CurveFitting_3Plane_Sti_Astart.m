function CurveFitting_3Plane_Sti_Astart(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol, OutputPath)
...
OutputPath=['C:\Aihua\z_TempOutputs\Vestibular\'];% OutputPath=['Z:\Users\Aihua\z_tempOutputs\'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
StimulusType=1;%Vestibular: 1; Visual=2; Combined:3.
%%%******************************%%%
%xy: Horizontal plane
Azi_hor=[0:45:315];Ele_hor=0*ones(1,8);
CurveFit_Hor=CurveFittingPlot_Astart(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough,StimulusType);
%Save the figure 
FigureIndex=2;
...
CurveFit_Front=CurveFittingPlot_Astart(FILE,'Frontal Plane',Azi_3D,Ele_3D,Azi_Front,Ele_Front,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough,StimulusType);
...
CurveFit_Med=CurveFittingPlot_Astart(FILE,'Median Plane',Azi_3D,Ele_3D,Azi_Med,Ele_Med,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough,StimulusType);
...
if k>1
    ...
    OutputPath=['C:\Aihua\z_TempOutputs\Visual\'];
    %%%******************************%%%
    %xy: Horizontal plane
    Azi_hor=[0:45:315];Ele_hor=0*ones(1,8);
    CurveFit_Hor=CurveFittingPlot_Astart(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough,StimulusType);
...
if k>2
    ...
    OutputPath=['C:\Aihua\z_TempOutputs\Combined\'];
    %%%******************************%%%
    %xy: Horizontal plane
    Azi_hor=[0:45:315];Ele_hor=0*ones(1,8);
    CurveFit_Hor=CurveFittingPlot_Astart(FILE,'Horizontal Plane',Azi_3D,Ele_3D,Azi_hor,Ele_hor,Step,x_time,x_stop,StepMatrix,StdMatrix,SpikeCount_Trial,p_peak,Value_peak,TimeIndex_peak,p_trough,Value_trough,TimeIndex_trough,StimulusType);
