...
function basis_model_contour_plots2(unique_azimuth, unique_elevation, ...
    unique_point_azimuth, unique_point_elevation, r1_resp, r2_resp, r3_resp, r4_resp, r5_resp, fig_num, tizzy)
...
if ~fig_exists
    ss = get(0,'ScreenSize');
    pos = [0.2*ss(3) 0.1*ss(4) 0.8*ss(3) 0.4*ss(4)];
    set(h,'Position',pos);
end
...
% [C h] = contourf(plot_azimuth,plot_elevation,plot_r1_data);
% set(gca,'ydir','reverse','xdir','reverse','xtick',x_tick,'ytick',y_tick);
...
% [C h] = contourf(plot_azimuth,plot_elevation,plot_r2_data);
% set(gca,'ydir','reverse','xdir','reverse','xtick',x_tick,'ytick',y_tick);
% axis([x_min,x_max,y_min,y_max]); if plot_clabels2, clabel(C,h), end;    
...
% [C h] = contourf(plot_azimuth,plot_elevation,plot_r3_data);
% set(gca,'ydir','reverse','xdir','reverse','xtick',x_tick,'ytick',y_tick);
% axis([x_min,x_max,y_min,y_max]); if plot_clabels2, clabel(C,h), end;    
...
% [C h] = contourf(plot_azimuth,plot_elevation,plot_r4_data);
% set(gca,'ydir','reverse','xdir','reverse','xtick',x_tick,'ytick',y_tick);
% axis([x_min,x_max,y_min,y_max]); if plot_clabels2, clabel(C,h), end;    
...
% [C h] = contourf(plot_azimuth,plot_elevation,plot_r5_data);
% set(gca,'ydir','reverse','xdir','reverse','xtick',x_tick,'ytick',y_tick);
% axis([x_min,x_max,y_min,y_max]); if plot_clabels2, clabel(C,h), end;    
