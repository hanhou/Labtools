function [data, choptime] = SpikeCorrC(data, windowflag, SpikeChan, SpikeChan2)
...
%    [correl, lags] = xcorr(spike_data1, spike_data2, 50,'coeff');   
...
%         [correl0, lags0] = xcorr(temp01, temp02, 50,'coeff');%Add by AHC 04-12-06
        correl_temp = correl0+correl_temp;
    end
    
    %correl_temp = correl0+correl_temp/num_trials;%Add by AHC 04-12-06
