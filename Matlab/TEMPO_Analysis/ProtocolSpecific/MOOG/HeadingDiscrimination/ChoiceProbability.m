function [Bias_psy,Thresh_psy,Bias_neu,Thresh_neu,CP_all,p]=ChoiceProbability(data, Protocol, Analysis, SpikeChan, StartEventBin, StopEventBin,StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, OptimalWindow);
...
text(70,10,['Optimal Window:',num2str(min(OptimalWindow)-StartEventBin(1,1)),' ~ ', num2str(max(OptimalWindow)-StartEventBin(1,1)), 'ms']);
