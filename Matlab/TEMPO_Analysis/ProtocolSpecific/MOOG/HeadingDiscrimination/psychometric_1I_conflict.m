...
%     %first the single-cues
%     figure(2);
%     set(2,'Position', [200,10 700,700], 'Name', 'Heading Discrimination');
...
%         if j == 1
%             text(40,8-j,num2str(Wves_actual_minus(1)) );
%         elseif j == 3
%             text(40,8-j,num2str(Wves_actual_plus(1)) );
%         else
%             text(40,8-j,num2str(Wves_actual(1)) );
%         end
%     end
% 
%     axis off;       
%     
%     % High coherence    	
%     axes('position',[0.1,0.05, 0.45,0.28] );
%     % fit data with cumulative gaussian and plot both raw data and fitted curve
%     legend_txt = [];
% 
%     for j = 1:length(unique_condition)    % <-- currently conflict_angle  
...
%     end
% 
%     axes('position',[0.6,0.05, 0.4,0.25] );
%     xlim( [0,50] );
%     ylim( [2,10] );
%     text(0,10, ['stimtype = ' num2str(unique_stim_type(s))]);
%     text(20,8.3, 'bias');
...
%         if j == 1
%             text(40,8-j,num2str(Wves_actual_minus(2)) );
%         elseif j == 3
%             text(40,8-j,num2str(Wves_actual_plus(2)) );
%         else
%             text(40,8-j,num2str(Wves_actual(2)) );
%         end
%     end
% 
%     axis off;   
