...
%---Modified for fitting rotation data by Yong, 7/20/06
%-----------------------------------------------------------------------------------------------------------------------
function Heading_CurveFit_Rot(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, ...
    StartOffset, StopOffset, PATH, FILE, OPT_FILE);

Curvefit_defines;
script_name = 'DirectionTuningPlot_Curvefit_Rot';
