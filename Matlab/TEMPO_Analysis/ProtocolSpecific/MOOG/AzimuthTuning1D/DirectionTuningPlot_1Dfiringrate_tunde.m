...
%     buff = sprintf(sprint_txt, FILE, resp_8(:,1), resp_8_std(:,1), resp_8_std_root(:,1) ); %done to accomodate aihua's data
...
%         outfile = ['Z:\Data\Tempo\Batch Files\Tunde\VIP_CELLS_AIHUA\dat_output\batch_VIP_VestiSigHor_1D.dat'];
        outfile = ['Z:\Data\Tempo\Batch Files\Tunde\VIP_CELLS_AIHUA\dat_output\batch_VIP_VisSigHor_1D.dat'];
