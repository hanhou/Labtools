...
function Azimuth1D_PSTH_HH(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol);
...
for k=1: length(unique_condition_num) 
    % define figure
    figure(k+2);
    set(k+2,'Position', [5,5 1000,700], 'Name', '1D Azimuth Tuning');
    orient landscape;
    title(FILE);
    axis off;
