...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ROTATION (zero, actual_plus, actual_minus, alph, gaze_dir, fignum)
% Given the calculated vectorsum (pref heading) in a 3D_Vary_Fixation experiment, 
...
set(fignum,'Position', [300*(fignum-4),0, 800,650], 'Name', 'Actual and expected rotations of vectorsum');
...
% first take the normal (cross product) of each pair of vectors, 
% and use them (and their lengths) to get the plane projection of actuals
...
% where Ea and Eb are the elevation of vectors a and b, and Aa and Ab = azimuth of a and b
