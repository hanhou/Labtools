function [exp_plus_sph, exp_minus_sph, shift_ratio_plus, shift_ratio_minus, shift_ratio_plusminus, noise_ratio_plus, noise_ratio_minus, noise_ratio_plusminus] = rotation(zero, actual_plus, actual_minus, alph, gaze_dir, fignum, FILE);
...
% --------------------------------------------------------------
% Output diff_exp's and diff_proj's to compare w/ SR (for vertical problem)
buff = sprintf('%s\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t %6.3f\t', FILE, diff_exp_plus, diff_exp_minus, diff_exp_plusminus, ... 
    diff_proj_plus, diff_proj_minus, diff_proj_plusminus, shift_ratio_plus, shift_ratio_minus, shift_ratio_plusminus, gaze_dir);
outfile = ['Z:\Users\Chris2\Dir3D_vertical_problem.dat'];
printflag = 0;
...
fid = fopen(outfile, 'a');
if (printflag)
    fprintf(fid, 'FILE\t diff_exp_plus\t diff_exp_minus\t diff_exp_plusminus\t diff_proj_plus\t diff_proj_minus\t diff_proj_plusminus\t shift_ratio_plus\t shift_ratio_minus\t shift_ratio_plusminus\t gaze_dir');
    fprintf(fid, '\r\n');
end
fprintf(fid, '%s', buff);
fprintf(fid, '\r\n');
