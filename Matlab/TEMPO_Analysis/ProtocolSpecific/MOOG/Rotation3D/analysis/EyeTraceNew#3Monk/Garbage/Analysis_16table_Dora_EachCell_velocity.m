...
[AX,H1,H2] = plotyy(x, res_y_up(i,:)',x, vel_y_up2(i,:)');
set(H1,'Color','b')
set(H2,'color','k')
set(get(AX(1),'Ylabel'),'String','(deg)')
set(get(AX(2),'Ylabel'),'String','(deg/sec)')
title(['Eye Position /  ',title1, p_title, '    /Eye Velocity']);
...
set(get(AX(1),'Ylabel'),'String','(deg)')
set(get(AX(2),'Ylabel'),'String','(deg/sec)')
title(['Eye Position /  ',title2, p_title, '    /Eye Velocity']);
 
    
    
  subplot(4,2,5);
    [AX,H1,H2] = plotyy(x, res_x_left(i,:)',x, vel_x_left2(i,:)');
set(H1,'Color','b')
set(H2,'color','k')
set(get(AX(1),'Ylabel'),'String','(deg)')
set(get(AX(2),'Ylabel'),'String','(deg/sec)')
title(['Eye Position /  ',title3, p_title, '    /Eye Velocity']);
  
    
    
  subplot(4,2,7);
     [AX,H1,H2] = plotyy(x, res_x_right(i,:)',x, vel_x_right2(i,:)');
set(H1,'Color','b')
set(H2,'color','k')
set(get(AX(1),'Ylabel'),'String','(deg)')
set(get(AX(2),'Ylabel'),'String','(deg/sec)')
title(['Eye Position /  ',title4, p_title, '    /Eye Velocity']);
