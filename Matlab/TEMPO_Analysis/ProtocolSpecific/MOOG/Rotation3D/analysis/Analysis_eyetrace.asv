...
clear all
% choose protocol
% analyze_protocol = 'rotation_ves';
% analyze_protocol = 'rotation_vis';
analyze_protocol = 'translat_ves';
...
elseif analyze_protocol == 'rotation_vis'
    aa = dlmread('Eye_rot_vis.dat','',1,1);  % load data
%     aa = dlmread('Eye_rot_ves.dat','',1,1);  % load data
...
elseif analyze_protocol == 'translat_ves'
    aa = dlmread('Eye_tra_ves.dat','',1,1);  % load data
%     aa = dlmread('Eye_rot_ves.dat','',1,1);  % load data
    title1 = 'tran ves up';
