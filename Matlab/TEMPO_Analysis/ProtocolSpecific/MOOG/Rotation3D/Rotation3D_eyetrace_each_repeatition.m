...
% outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Zebulon_ves.dat'];
% outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Zebulon_vis.dat'];

% outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Azrael_ves.dat'];
outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Azrael_vis.dat'];

% outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Que_ves.dat'];
% outfile = [BASE_PATH 'ProtocolSpecific\MOOG\Rotation3D\Eye_rot_Que_vis.dat'];
