...
%                    Que Zebulon Right Eye Ch. Hor = 3  Ver = 4
...
%                    Azrael Right Eye Ch. Hor = 1  Ver = 2 
...
figure(3)
plot(re_x_up{1},'r');hold on; plot(re_y_up{1},'b');hold off

figure(4)
plot(re_x_down{1},'r');hold on; plot(re_y_down{1},'b');hold off

figure(5)
plot(re_x_left{1},'r');hold on; plot(re_y_left{1},'b');hold off

figure(6)
plot(re_x_right{1},'r');hold on; plot(re_y_right{1},'b');hold off
