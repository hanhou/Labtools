...
terms = CURVEFIT_NUM_FIXED_PARAMETERS_HC_8P_ASP_NG + dyn_terms*num_gazes;

% create bounds for the fixed parameters for this model.
% the fixed parameters are azimuth and elevation rotation angles.
lb = [-2*pi  -2*pi   -50  -50  0   0   0 -50];
ub = [ 2*pi   2*pi  50     50 5e3 5e3 1 50];
...
% the fixed parameters are azimuth and elevation rotation angles.
x0 = rand(1,CURVEFIT_NUM_FIXED_PARAMETERS_HC_8P_ASP_NG).*[2*pi pi 4 4 0 0 1 4] - [pi pi/2 2 2 -amplitude -amplitude 0 2];
