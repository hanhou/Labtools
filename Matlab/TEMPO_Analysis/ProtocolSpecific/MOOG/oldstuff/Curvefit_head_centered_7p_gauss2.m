...
curvefit_parameter_mapping(CURVEFIT_PARAM_NONLIN) = 5;
curvefit_parameter_mapping(CURVEFIT_PARAM_NONLIN2) = 6;
...
for f=1:num_gazes
    ...
    [primary,secondary]=Curvefit_cos_tuning_7p_gauss_seperator2(P,azimuth, elevation);
