...
% the fixed parameters are azimuth and elevation rotation angles.
x0 = rand(1,CURVEFIT_NUM_FIXED_PARAMETERS_HC_6P_NG).*[2*pi pi 2 0 0 1] - [pi pi/2 0 -amplitude -amplitude 0];
