...
lb = [-2*pi  -2*pi   0   0   0   0 0];
ub = [ 2*pi   2*pi  50   5e3 5e3 1 50];
...
% the fixed parameters are azimuth and elevation rotation angles.
x0 = rand(1,CURVEFIT_NUM_FIXED_PARAMETERS_HC_7P_ASP_NG).*[2*pi pi 2 0 0 1 2] - [pi pi/2 0 -amplitude -amplitude 0 0];
