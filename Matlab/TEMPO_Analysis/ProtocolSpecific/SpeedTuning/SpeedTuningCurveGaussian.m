...
%--	GCD, 3/10/05
%-----------------------------------------------------------------------------------------------------------------------
function SpeedTuningCurveGaussian(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
if output == 1
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\SpeedTuning\SpeedTuningSummary_Gaussian.dat'];
    printflag = 0;
