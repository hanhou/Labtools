...
function   PrintSpeedData(speeds, spk_rates, max_stats, min_stats, speed_groups, spont_level, fit_params, fit_error, p_value, avg_resp, stats1, stats2, SDI, chi2, chiP);
...
text(xpos,ypos,line,'FontSize',font_size);		ypos = ypos - bump_size;  
line = sprintf('Center q(3) = %0.3g', fit_params(3));
text(xpos,ypos,line,'FontSize',font_size);		ypos = ypos - bump_size;       
line = sprintf('Sigma = %0.3g', fit_params(4));
text(xpos,ypos,line,'FontSize',font_size);		ypos = ypos - bump_size;       
